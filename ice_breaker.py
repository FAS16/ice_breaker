...
if __name__ == '__main__':
    ...
    summar_prompt_template = PromptTemplate(input_variables=["information"], template=summary_template)

    llm = ChatOllama(model="llama3")
    # llm = ChatOllama(model="mistral")

    chain = summar_prompt_template | llm | StrOutputParser()
